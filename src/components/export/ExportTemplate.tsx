...
export const ExportTemplate = forwardRef<HTMLDivElement, ExportTemplateProps>(
  function ExportTemplate({ hero, proximas, mesLabel }, ref) {
    ...
    return (
      <div ref={ref} className={styles.canvas}>
        ...
        <div className={styles.footer}>
          <div className={styles.aviso}>Informe indisponibilidade com até uma semana de antecedência · Ministério de Louvor, Igreja Batista Memorial</div>
